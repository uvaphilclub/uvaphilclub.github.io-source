...
const IndexPage = () => (
  <Layout>
   <body className="min-h-screen">
        <div className="flex flex-col md:flex-row justify-center pt-6 pb-6 pl-6 items-center gap-12 my-12">
            <div className="flex flex-col mb-12 max-w-md ml-auto">
                <div className="max-w-64">
                    <h1 className="text-6xl text-start">Our Mission</h1>
                </div>
                <ul>
            ...
            <div className="p-10 basis-1/2 bg-gradient-to-r from-silver to-lightsilver max-w-5xl">
                <SimpleImageSlider
                    width={700}
                    height={500}
        ...
        <div className="flex flex-wrap justify-center p-6 my-12 max-w-5xl mx-auto ">
        <QuoteComponent />
        </div>
