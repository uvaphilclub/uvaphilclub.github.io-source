...
const Contact = () => {
    ...
    <div className="min-h-screen mx-auto">
        <div className="flex flex-wrap justify-center gap-x-20 py-6 bg-blue min-w-full">
            <h1 className="mb-6 sm:mb-0 self-center text-4xl italic">Get Connected</h1>
            <ul className="text-xl font-['Shanti']">
                ...
                <li className="flex flex-wrap  items-center justify-between">
                    Join the email list: <div className="text-2xl"><a href="https://lists.virginia.edu/sympa/subscribe/phil.club" className="fa fa-envelope text-center"></a></div>
                </li>
