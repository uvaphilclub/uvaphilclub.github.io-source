...
const StickyNote = ({event}) => {
    ...
    return(
        <div className= {`sticky-note flex flex-wrap flex-col h-64 justify-between w-64 bg-yellow shadow-[5px_5px_7px_rgba(33,33,33,.7)] m-4 p-4 rotate-[${angle}deg] -top-4`}>
            <div>
